  ...
  return (
    <div className="flex justify-center items-center h-[70vh]">
      <div className="glass-panel p-8 rounded-2xl border border-white/10 w-full max-w-md">
        <h1 className="font-syne text-3xl font-bold text-white mb-6 text-center">Welcome Back</h1>
        ...
        <p className="text-center text-sm text-gray-400 mt-6">
          Don't have an account? <Link to="/signup" className="text-primary-soft font-bold hover:text-white transition-colors">Sign up</Link>
        </p>
      </div>
    </div>
  );
